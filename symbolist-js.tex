...
In \symbolist mapping between \textit{performance media} and \textit{graphic representation} is achieved through first mapping to semantic data.
...
\begin{figure}[ht!]
\centering
\includegraphics[width=0.8\columnwidth]{score-lookup.pdf}
